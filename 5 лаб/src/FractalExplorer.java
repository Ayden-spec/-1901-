...
public class FractalExplorer {
    ...
    public void createAndShowGUI() {
        ...
        FractalGenerator tricornFractal = new Tricorn();  //Добавили выпадающее окно фракталов
    ...
    /**ActionListener. В случае, если событие поступило от выпадающего
    ...
    private class ButtonHandler implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource() instanceof JComboBox) {
                ...
                JFileChooser myFileChooser = new JFileChooser(); //Переделанный пример сохранения картинки в пнг формате
                FileFilter extensionFilter =//
                new FileNameExtensionFilter("PNG Images", "png");//
                myFileChooser.setFileFilter(extensionFilter);//
                myFileChooser.setAcceptAllFileFilterUsed(false);//

                int userSelection = myFileChooser.showSaveDialog(display); //showSaveDialog() открывает диалоговое окно «Save file»

                if (userSelection == JFileChooser.APPROVE_OPTION) {

                    java.io.File file = myFileChooser.getSelectedFile(); //Узнает директорию сохранения
                    String file_name = file.toString();

                    try {
                        BufferedImage displayImage = display.getImage();
                        javax.imageio.ImageIO.write(displayImage, "png", file); //загрузка и сохранение изображения
                    }
